...
export default function MemoryRules() {
  return (
    <div className='w-full h-screen bg-center bg-cover flex flex-col justify-between items-start pl-20 py-20' style={{ fontFamily: 'gambado-sans', backgroundImage: `url(${memory})` }}>
